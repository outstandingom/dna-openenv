...
HF_TOKEN = os.getenv("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", "")
SPACE_URL = os.getenv("https://huggingface.co/spaces/OutstandingOm/dna-openenv/", "http://localhost:7860")  # Your HF Space URL
